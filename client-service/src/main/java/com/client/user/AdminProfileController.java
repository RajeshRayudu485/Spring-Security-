...
public class AdminProfileController {
    ...
    public Mono<ResponseEntity<String>> getAdminProfile(
        ...
        log.info(" Fetching admin profile using token: {}", token);
        ...
        return webClientBuilder.build()
                ...
                .doOnSuccess(res -> log.info(" Admin profile fetched with status: {}", res.getStatusCode()))
                .doOnError(e -> log.error(" Failed to fetch admin profile", e))
                .onErrorMap(e -> new RuntimeException("Error fetching admin profile", e));
    }
}
