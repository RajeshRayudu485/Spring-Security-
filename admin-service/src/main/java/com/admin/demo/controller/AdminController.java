...
import com.admin.demo.admin.dto.AuthRequest;
import com.admin.demo.admin.dto.UserResponse;
import com.admin.demo.admin.dto.ValidationResponse;
...
public class AdminController {
	...
	public ResponseEntity<ValidationResponse> loginAdmin(@RequestBody AuthRequest authRequest) {
	    ...
	    ValidationResponse response = new ValidationResponse(true, userResponse);
	...
	@GetMapping("/profile")
	public ResponseEntity<Admin> getAdminProfile(@RequestHeader("X-User-Id") Long adminId) {
	    logger.info("Profile request received for admin ID from header: {}", adminId);
	    ...
	    logger.info("Returning profile for admin ID: {}", adminId);
	    return ResponseEntity.ok(admin);
	}
